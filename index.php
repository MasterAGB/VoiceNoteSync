...
if ($requestType) {
    switch ($requestType) {
        ...
        case 'getNotes':
            ...
            break;
        default:
            $response = ['error' => 'Incorrect request type. Follow this link to fix request: ' . DOMAIN.'?help='.time()];
    }
...
if ($newKeyGenerated) {
    $response = [
        ...
        'examples' => [
            ...
            'saveDalleImagePrompt' => DOMAIN . '?type=dalleImage&content=ImagePrompt&secretKey=' . $secretKey,
    ...
    <?php if (!empty($response['newKeyGenerated']) && $response['newKeyGenerated']): ?>
        ...
        <div class="container mt-4">
            ...
            <ul>
                ...
                <li><strong>DALL·E Image Prompt</strong>: Uses <code>type=dalleImage</code> with a <code>content</code> parameter for Image Prompt, that was used for Generate the specific image by DALL·E. Note: When asked to store an image generated by DALL·E, only the prompt used for generation is stored.</li>
            ...
            <ul>
                ...
                <li><strong>User</strong>: "Create a DALL·E prompt for an image of a beautiful futuristic cityscape."</li>
                <li><strong>ChatGPT</strong>: Constructs the GET request URL with the DALL·E prompt: <code>https://enigma.lv/VoiceNoteSync/?type=dalleImage&content=[Here goes prompt, that was used to generate the result image]&secretKey=[User's Secret Key]</code>.</li>
                <li><strong>ChatGPT</strong>: Executes the request, checks the response, and informs the user: "DALL·E image prompt for a beautiful futuristic cityscape has been saved."</li>
            </ul>
